...
//uint32_t RX_Black_List[] = {0x0d898e88}; /* EAPOL 888E, TDLS 890D */
//uint32_t RX_Black_List[] = {0x888e0800}; /* EAPOL 888E, TDLS 890D */
uint32_t RX_Black_List[] = {}; /* EAPOL 888E, TDLS 890D */
uint32_t TCI[] = {0x10021001, 0x10041003, 0x10061005, 0x10081007};
uint32_t RX_WCID_En[] = {0xFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF};
#endif
